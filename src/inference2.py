...
ADAPTER_PATH = PROJECT_ROOT / "outputs" / "mlp_v1"
...
# Speicherordner fuer erzeugte H5P-Dateien
...
def build_prompt(tokenizer, question: str) -> str:
    ...
    # add_generation_prompt=True fuegt den Header fuer den Assistant automatisch an
    # (z.B. <|assistant|>\n), damit das Modell weiss: Jetzt bin ich dran!
    return tokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=True)


def model_answer(question: str) -> str:
    """Ruft das Modell auf."""
    # Uebergeben Sie den geladenen Tokenizer als erstes Argument
...
def next_content_filename() -> str:
    """Erzeugt den naechsten content_XXX.json Namen."""
